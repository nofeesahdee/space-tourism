...
export default function Home() {
  return (
    ...
    >
      < div className="py-10" >
        <Navbar />
        <div className="flex flex-col items-center p-6 md:pt-28 lg:flex-row lg:px-28 lg:justify-between">
          <div className="tracking-[1px] lg:w-1/2 lg:text-left text-center w-full mb-12 lg:mb-0">
            ...
            <h1 className="text-[80px] lg:text-9xl uppercase py-6">Space</h1>
            <p className="text-sm md:text-base lg:text-lg text-[#D0D6F9] lg:px-0">
